---
layout: default 
title: From the Gibbs variational principle to the Donsker-Varadhan lemma 
---
...
$$
    u_n(x) \coloneqq \max \Big( \min \big( \rho(x), n), \frac{1}{n} \Big). 
$$
